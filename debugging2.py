class FoodItem:
    ...
    def __init__(self, name, price):
        '''Initialize a food item with a name and price.'''
        self.name = name
        self.price = price
...
class Restaurant:
    ...
    def __init__(self, name):
        '''Initialize a restaurant with a name and an empty menu.'''
        self.name = name
        self.menu = {}

    def add_to_menu(self, food_item, quantity):
        '''Add a food item to the menu with a specified quantity.'''
    ...
    def remove_from_menu(self, food_item, quantity):
        '''Remove a food item from the menu with a specified quantity.'''
        if food_item in self.menu:
    ...
    def get_total_revenue(self):
        '''Calculate and return the total revenue generated by the restaurant.'''
        total_revenue = 0
...
class Customer:
    ...
    def __init__(self, name, address):
        '''Initialize a customer with a name, address, and an empty cart.'''
        self.name = name
        self.address = address
        self.cart = {}

    def add_to_cart(self, food_item, quantity):
        '''Add a food item to the customer's cart with a specified quantity.'''
        if quantity > 0:
    ...
    def remove_from_cart(self, food_item, quantity):
        '''Remove a food item from the customer's cart with a specified quantity.'''
        if food_item in self.cart:
...
class DeliveryService:
    ...
    def __init__(self):
        '''Initialize a delivery service with an empty list of restaurants.'''
        self.restaurants = []
